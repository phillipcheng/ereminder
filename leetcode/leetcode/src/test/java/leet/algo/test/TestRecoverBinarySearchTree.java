...
public class TestRecoverBinarySearchTree {
	...
	@Test
	public void test1(){
		TreeNode tn = TreeNodeUtil.bfsFromString("5,3,7,1,4,6,8,#,#,#,#,#,#,#,#");
		RecoverBinarySearchTree rbst = new RecoverBinarySearchTree();
		rbst.recoverTree(tn);
		String str = TreeNodeUtil.bfsToString(tn);
		logger.info(str);
	...
	@Test
	public void test2(){
		TreeNode tn = TreeNodeUtil.bfsFromString("5,7,3,1,4,6,8,#,#,#,#,#,#,#,#");
		RecoverBinarySearchTree rbst = new RecoverBinarySearchTree();
		rbst.recoverTree(tn);
		String str = TreeNodeUtil.bfsToString(tn);
		logger.info(str);
	...
	@Test
	public void test3(){
		TreeNode tn = TreeNodeUtil.bfsFromString("5,3,8,1,4,6,7,#,#,#,#,#,#,#,#");
		RecoverBinarySearchTree rbst = new RecoverBinarySearchTree();
		rbst.recoverTree(tn);
		String str = TreeNodeUtil.bfsToString(tn);
		logger.info(str);
