...
import org.cld.stock.stockbase.CrawlCmdGroupType;
import org.cld.stock.stockbase.CrawlCmdType;
...
public abstract class StockBase extends TestBase{
	...
	public void validateAllStrategyByStock(String inparam){
		...
		validateAllStrategyByStock(this.propFile, cconf, baseMarketId, marketId, startDate, endDate, snParam, stepParam, TradeHour.Normal);
	}
