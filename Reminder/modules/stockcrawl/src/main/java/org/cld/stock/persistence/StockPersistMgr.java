...
public class StockPersistMgr {
	...
	public static List<String> getStockIds(DBConnConf dbconf, ETLConfig sc){
		return getStockIds(dbconf, sc, 0);
	}
	
	public static List<String> getStockIds(DBConnConf dbconf, ETLConfig sc, int limit){
		Connection con = null;
	...
	public static Map<String, Date> getStockIPOData(ETLConfig sc, DBConnConf dbconf){
	...
	public static Map<String, Date> getStockLUDateByCmd(ETLConfig sc, String cmd, DBConnConf dbconf){
	...
	public static Date getMarketLUDateByCmd(ETLConfig sc, String cmd, DBConnConf dbconf){
		Connection con = null;
		Statement stmt = null;
		String query = "";
		Date d = null;
