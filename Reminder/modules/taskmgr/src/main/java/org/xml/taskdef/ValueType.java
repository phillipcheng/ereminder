 ...
 *         &lt;element name="pageVerify" type="{}PageVerifyType" maxOccurs="unbounded" minOccurs="0"/>
 *       &lt;/sequence>
...
public class ValueType {
    ...
    protected List<PageVerifyType> pageVerify;
     ...
     * 
     */
    public List<PageVerifyType> getPageVerify() {
        if (pageVerify == null) {
            pageVerify = new ArrayList<PageVerifyType>();
        }
