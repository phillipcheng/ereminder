 ...
 *         &lt;element name="redirectedURL" type="{}ValueType" maxOccurs="unbounded"/>
 *         &lt;element name="loginURL" type="{}ValueType" minOccurs="0"/>
...
public class LoginType {
    ...
    @XmlElement(required = true)
    protected List<ValueType> redirectedURL;
    protected ValueType loginURL;
     ...
     * 
     */
    public List<ValueType> getRedirectedURL() {
        if (redirectedURL == null) {
            redirectedURL = new ArrayList<ValueType>();
        }
     ...
     *     
     */
    public void setLoginURL(ValueType value) {
        this.loginURL = value;
    }
