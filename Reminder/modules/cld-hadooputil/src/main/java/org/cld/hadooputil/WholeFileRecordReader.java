...
public class WholeFileRecordReader extends RecordReader<Text, Text> {
	...
	public static final Logger logger = Logger.getLogger(WholeFileRecordReader.class);
    ...
    //  private final Text mFileName;
      ...
      logger.info("FileToRead is: " + mFileToRead.toString());
      logger.info("Processing path " + pathToProcess + " out of " + fileSplit.getNumPaths());
      ...
      public Text getCurrentKey() throws IOException, InterruptedException {
        return new Text(mFileToRead.getName());
      }
